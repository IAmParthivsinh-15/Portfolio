...
const Hero = () => {
  return (
    <section className="min-h-screen flex items-center pt-20 overflow-hidden relative" id="home">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-center">
          <div className="lg:col-span-3 space-y-6">
            ...
            <p className="text-gray-300 max-w-2xl">
              ...
              With a strong foundation in cybersecurity and machine learning, I create
              robust, scalable, and secure digital solutions.
            </p>
          ...
          <div className="lg:col-span-2 relative hidden lg:block">
            <div className="w-80 h-80 mx-auto">
              <div className="w-full h-full rounded-full overflow-hidden border-4 border-violet-500/20 hover-scale">
                <div className="w-full h-full bg-gradient-to-br from-violet-600/30 to-indigo-600/30 backdrop-blur-sm flex items-center justify-center">
                  <span className="text-6xl">PV</span>
                </div>
              </div>
            </div>
          </div>
